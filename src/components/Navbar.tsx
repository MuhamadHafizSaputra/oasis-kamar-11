...
const Navbar = () => {
  return (
    // GANTI class shadow custom dengan 'shadow-md'
    <nav className="bg-[#F5E8D3] p-4 relative" style={{ boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.2), 0 2px 4px -2px rgba(0, 0, 0, 0.1)' }}>
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-12 flex-1 justify-center">
          <a href="#" className="text-black hover:text-gray-700">Makanan</a>
        ...
        <div className="flex space-x-4">
          ...
          <button className="bg-[#F5B041] text-black px-4 py-2 rounded-lg hover:bg-[#F39C12]">
            Sign up
          </button>
        </div>
      </div>
